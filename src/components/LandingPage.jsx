...
export default function LandingPage() {
  ...
  return (
    <main className="flex-1 overflow-hidden bg-white">
      ...
      <section id="realisations" className="px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
      ...
      <section id="contact" className="bg-[#020b18] px-5 py-16 text-white sm:px-8 lg:px-10 lg:py-24">
